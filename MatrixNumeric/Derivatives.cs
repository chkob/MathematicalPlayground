...
namespace MathematicalPlayground.NumericalMethods
{
   public class Derivatives
   {
      ...
      private MatrixNumeric[] _coefficients;
      private Derivatives()
      {
      }
      ...
      {
         _coefficients = new MatrixNumeric[numberOfPoints];
         for (int i = 0; i < numberOfPoints; i++)
         {
            MatrixNumeric deltsMatrix = new MatrixNumeric(numberOfPoints, numberOfPoints);
      ...
      {
         int numberOfPoints = _coefficients.Length; double result = 0.0;
         ...
         for (int i = 0; i < numberOfPoints; i++)
         {
            parameter.Value = originalValue + ((double)(i - centerPoint)) * derivativeStepSize; points[i] = function();
         }
